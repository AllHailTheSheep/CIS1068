...
public class lab8tests {
    ...
    public void testInitialize() {
      ...
      int[] A = new int[5];
      int initialValue = 5;
      lab8.initialize(A, initialValue);
    ...
    public void testAverage() {
      ...
      double result = lab8.average(A);
      assertEquals(expResult, result, 0.1);

      int B[] = { 31 };
      expResult = 31.0;
      result = lab8.average(B);
      assertEquals(expResult, result, 0.1);
    }
    ...
    public void testNumOccurrences() {
      ...
      int x = 16;
      int expResult = 3;
      int result = lab8.numOccurrences(A, x);
      assertEquals(expResult, result);

      x = 37;
      expResult = 0;
      result = lab8.numOccurrences(A, x);
      assertEquals(expResult, result);
    ...
    public void testFind() {
      ...
      int x = 37;
      int expResult = -1;
      int result = lab8.find(A, x);
      assertEquals(expResult, result);

      x = 16;
      expResult = 1;
      result = lab8.find(A, x);
      assertEquals(expResult, result);
    }
    ...
    public void testFindN() {
      ...
      int n = 0;
      int expResult = -1;
      int result = lab8.findN(A, item, n);
      assertEquals(expResult, result);

      item = 21;
      n = A.length;
      expResult = 0;
      result = lab8.findN(A, item, n);
      assertEquals(expResult, result);
    ...
    public void testFindLast() {
      ...
      int x = 37;
      int expResult = -1;
      int result = lab8.findLast(A, x);
      assertEquals(expResult, result);

      x = 31;
      expResult = 3;
      result = lab8.findLast(A, x);
      assertEquals(expResult, result);
    ...
    public void testIndexOfLargest() {
      ...
      int[] A = { 21, 16, 5, 31, 8, 1, 9, 1, 16, 4, 2, 16 };
      int expResult = 3;
      int result = lab8.indexOfLargest(A);
      assertEquals(expResult, result);
    }
    ...
    public void testIndexOfLargestOdd() {
      ...
      int[] A = { 21, 16, 5, 31, 8, 1, 9, 1, 16, 4, 2, 16 };
      int expResult = 3;
      int result = lab8.indexOfLargestOdd(A);
      assertEquals(expResult, result);

      int[] B = { 20, 16, 4, 32, 8, 2, 8, 2, 16, 4, 2, 16 };
      expResult = -1;
      result = lab8.indexOfLargestOdd(B);
      assertEquals(expResult, result);
    }
    ...
    public void testCopy() {
      ...
      int[] result = lab8.copy(A);
      assertArrayEquals(expResult, result);

      int[] A2 = { 21 };
      int[] expResult2 = { 21 };
      int[] result2 = lab8.copy(A2);
    ...
    public void testUniques() {
      ...
      int[] A = { 21, 16, 5, 31, 8, 1, 9, 1, 16, 4, 2, 16 };
      int[] expResult = { 21, 5, 31, 8, 9, 4, 2 };
      int[] result = lab8.uniques(A);
      assertArrayEquals(expResult, result);
    }
  }
